...
<body>
    ...
    <div class="container text-center" id="HomeBody">
        ...
        <div class="row">
            <div class="col">
                <img src="img/img_Index/sign1.png" width="250" height="250" id="ppd">
            </div>
            <div class="col">
                <img src="img/img_Index/sign2.png" width="250" height="250" id="ppd">
            </div>
            <div class="col">
                <img src="img/img_Index/sign3.png" width="250" height="250" id="ppd">
            </div>
        </div>
        <br>
        <hr>
        ...
        <div class="row">
            <div class="col">
                <img src="img/img_Index/sign4.png" width="250" height="250" id="ppd">
            </div>
            <div class="col">
                <img src="img/img_Index/sign5.png" width="250" height="250" id="ppd">
            </div>
            <div class="col">
                <img src="img/img_Index/sign6.png" width="250" height="250" id="ppd">
            </div>
    ...
    <div class="container text-center" id="HomeBody2">
        <div class="row">
            ...
            <div class="row">
                <p><a class="link-hme" href="acoessociais.php">Conheça nossa pagina de ações sociais!!</a></p>
            </div>
        </div>
        <div class="callout text-center" id="caixa">
            <h4>Mais de doados as ONG's!!!</h4>
        </div>
    </div>
